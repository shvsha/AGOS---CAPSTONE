...
from .views import ( SensorNodeListView, SensorNodeDetailView, SensorNodeByBarangayView, SystemHealthLogListView, SystemHealthLogByNodeView, SensorNodeDecommissionView )
...
urlpatterns = [
    ...
    path('sensor-nodes/<int:node_id>/decommission/', SensorNodeDecommissionView.as_view(), name='sensor-node-decommission'),
