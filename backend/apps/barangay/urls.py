...
from .views import BarangayListView, BarangayDetailView, BarangayAllView, BarangayUnregisterView, BarangayRegisterView, BarangayCheckView
...
urlpatterns = [
    ...
    path('barangays/<int:barangay_id>/register/', BarangayRegisterView.as_view(), name='barangay-register'),
