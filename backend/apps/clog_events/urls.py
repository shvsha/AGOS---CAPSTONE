...
from .views import ( ClogEventListView, ClogEventDetailView, ClogEventByBarangayView, UpdateClogStatusView, ClogEventExportView 
                    )
...
urlpatterns = [
    ...
    path('clog-events/export/', ClogEventExportView.as_view(), name='clog-event-export'),
]