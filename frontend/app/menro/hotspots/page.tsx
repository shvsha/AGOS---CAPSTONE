...
export default function HotspotManagement() {
  // data
  const hotspotsCache = usePageCache('menroHotspots:hotspots', fetchHotspotsRaw, [] as Hotspot[], { autoFetch: false })
  const barangaysCache = usePageCache('menroHotspots:barangays', fetchBarangaysRaw, [] as Barangay[], { autoFetch: false })
  const nodesCache = usePageCache('menroHotspots:nodes', fetchNodesRaw, [] as SensorNode[], { autoFetch: false })
          ...
          <div ref={panelRef} className="bg-[#FAFCFD] border border-[#00000040] shadow-[0_5px_4px_-4px_rgba(0,0,0,0.2)] w-full rounded-lg flex flex-col">
            ...
            {!fetchError && filteredBarangays.length === 0 && (
              <div className="flex-1 flex flex-col items-center justify-center gap-3">
                ...
                <p className="text-[#727272] text-sm">No registered barangays match your search.</p>
              </div>
            )}
