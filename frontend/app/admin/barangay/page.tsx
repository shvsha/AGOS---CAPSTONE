...
import { MapPinned, CheckCircle, Archive, BadgeCheck, CircleOff, Map, UserRound, SquarePen, UserMinus, UserPlus, SlidersHorizontal, X } from "lucide-react";
      ...
      <div className="hidden md:flex flex-col">
        ...
        <div className="flex justify-between w-full mb-4">
          ...
          <div className="flex gap-3">
            ...
            {/* add barangay */}
            <Button
              onClick={() => router.push('/admin/barangay/form')}
                ...
                <TableRow>
                  <TableCell colSpan={6} className="text-center py-15">
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <Button
                        onClick={() => router.push('/admin/barangays/form')}
                  ...
                  paginated.map(barangay => (
                    <TableRow key={barangay.barangay_id} className="border-b border-[#C6C6C8]">
                      ...
                      <TableCell className="text-[#122A48] flex gap-3 justify-center items-center h-18">
                        <Button 
                          onClick={() => router.push(`/admin/barangays/form?id=${barangay.barangay_id}`)}
